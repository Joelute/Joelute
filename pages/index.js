        ...
        <section className={styles.about} id='about'>
          ...
          <div className={styles['about-container']}>
            <div className={styles['about-description']}>
              <p className={styles['about-description-text']}>Hello, I&apos;m Joseph Ho and I am a frontend developer based out of Toronto, Canada. I love building apps that solve real-world problems, and that are delightful to use. My specialities include Python, Javascript, React JS, and Styled Components.</p>
